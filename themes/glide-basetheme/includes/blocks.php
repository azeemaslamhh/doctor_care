...
function glide_theme_acf_init() {
	...
	if ( function_exists( 'acf_register_block' ) ) {
		...
		// Register a block - Key Features
		acf_register_block(
			array(
				'name'            => 'key-features',
				'title'           => __( 'Key Features', 'basetheme_td' ),
				'description'     => __( 'A custom Key Features.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
		...
		acf_register_block(
			array(
				...
				'title'           => __( 'image side text', 'basetheme_td' ),
				'description'     => __( 'A custom Key Features.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
		...
		acf_register_block(
			array(
				...
				'title'           => __( 'news and events', 'basetheme_td' ),
				'description'     => __( 'A news and events.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
		...
		acf_register_block(
			array(
				...
				'title'           => __( 'Board of Trustees', 'basetheme_td' ),
				'description'     => __( 'A Board of Trustees.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
		...
		acf_register_block(
			array(
				'name'            => 'mth-sevies',
				'title'           => __( 'MTH Services', 'basetheme_td' ),
				'description'     => __( 'A MTH Services.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
				'keywords'        => array( 'MTH Services' ),
				'align'           => 'wide',
				// calling assets js,css
				// 'enqueue_assets' => function(){
				// wp_enqueue_script( 'block-testimonial', get_template_directory_uri() . '/scripts/jquery.cycle2.min.js', array('jquery'), '', true );
		...
		acf_register_block(
			array(
				'name'            => 'feedback',
				'title'           => __( 'Feedback', 'basetheme_td' ),
				'description'     => __( 'A Feedback.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
		...
		acf_register_block(
			array(
				'name'            => 'appointment',
				'title'           => __( 'Appointment', 'basetheme_td' ),
				'description'     => __( 'A Appointment.', 'basetheme_td' ),
				'render_callback' => 'glide_acf_block_callback',
				'category'        => 'glide-blocks',
				'icon'            => 'images-alt2',
				'mode'            => 'edit',
				'keywords'        => array( 'Appointment' ),
				'align'           => 'wide',
				// calling assets js,css
				// 'enqueue_assets' => function(){
				// wp_enqueue_script( 'block-testimonial', get_template_directory_uri() . '/scripts/jquery.cycle2.min.js', array('jquery'), '', true );
