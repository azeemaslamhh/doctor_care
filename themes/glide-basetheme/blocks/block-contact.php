...
<section class="section contact-block">
                <div class="container">
                    <div class="map-block">
                        ...
                        <iframe src="<?php echo $mth_blk_contact_map;?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                        ...
                        <div class="col-block col-block-5">
                            ...
                            <ul class="contact-information">
                                <li>
                                    ...
                                    <div class="textbox">
                                        <address><?php echo $mth_blk_contact_address;?></address>
                                    </div>
                                </li>
                                <li>
                                    <strong class="title">Telephone</strong>
                                    <div class="textbox">
                                        <span class="text phone"><a href="tel:042-35915336"><?php echo $mth_blk_contact_telephone;?></a></span>
                                    </div>
                                </li>
                                <li>
                                    <strong class="title">E-mail</strong>
                                    <div class="textbox">
                                        <span class="text"><a href="mailto:info@modeltownhospital.com.pk"><?php echo $mth_blk_contact_email;?></a></span>
                                    </div>
                                </li>
                                <li>
